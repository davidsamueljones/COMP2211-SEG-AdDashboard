...
public enum Metric {
  ...
  BOUNCES_NUM_PAGES("Bounces - pages viewed", "Number of Bounces as number of pages viewed"),
  BOUNCES_TIME_SPENT("Bounces - time spent", "Number of Bounces as time spent on page"),
